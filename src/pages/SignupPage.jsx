          ...
          <div className="col-12 col-lg-5">
            ...
            >
              <div className="card-body p-4 p-lg-5">
                ...
                {/* Social placeholders (wire up if needed) */}
                <div className="d-grid gap-2">
                  <button className="btn btn-outline-secondary rounded-4" type="button" disabled>
                ...
                <p className="small text-muted mt-4 mb-0">
                  Already a member? <Link to="/login" className="text-decoration-none">Sign in</Link>.
                </p>
              </div>
            </motion.div>
          </div>
